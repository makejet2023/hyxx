...
export const scenes: Scene[] = [
  ...
  },
  {
    ...
    titleEn: 'Emergency',
    titleZh: '紧急情况',
    descriptionEn: 'Important phrases for emergency situations',
    descriptionZh: '紧急情况必备表达',
    icon: '🚨',
    dialogues: [
      {
        id: 'e1',
  ...
  },
  {
    ...
    titleZh: '社交礼仪',
    descriptionEn: 'Common phrases for social interactions',
    descriptionZh: '社交场合常用表达',
    icon: '👥',
    dialogues: [
      {
        id: 'so1',
